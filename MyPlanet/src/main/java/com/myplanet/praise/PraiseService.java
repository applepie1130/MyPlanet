...
public class PraiseService extends CommonService {
	...
	public List findMusicSheetListBySearch(Map paramMap) {
		List resultData = queryForListData("praiseQry.selectMusicSheetListBySearch", paramMap);
		return resultData;
	}
	...
	public List findMusicSheetListByFirstNm(Map paramMap) {
		List resultData = queryForListData("praiseQry.selectMusicSheetListByFirstNm", paramMap);
		return resultData;
	}
	...
	public List findtMusicSheetTotalCount(Map paramMap) {
		List resultData = queryForListData("praiseQry.selectMusicSheetTotalCount", paramMap);
		return resultData;
	}
	...
	public String findMusicSheetKeyWord() {
		...
		List rData = queryForListData("praiseQry.selectMusicSheetListBySearch", paramMap);
